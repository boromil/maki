...
const Error = error{NotFound, AccessDenied};
...
pub export fn entry_point() callconv(.c) void {}

test \"integration\" {}
";
    let out = idx(src, Language::Zig);
    has(
        &out,
        &[
            "module doc:",
            ...
            "pub fn init",
            "inline fn fast_add",
            "pub export fn entry_point",
            "tests:",
        ],
    );
    lacks(&out, &["MAX_CONN: u32 = 1024"]);
}
